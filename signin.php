...
<head>
    ...
    <title>Sign In – World Cuisine</title>
...
<div class="auth-card">
    ...
    <div class="success-banner">✓ <?= htmlspecialchars(urldecode($_GET['success']), ENT_QUOTES, 'UTF-8') ?></div>
    <?php endif; ?>
    ...
    <div class="divider"><span>new to world cuisine?</span></div>
    <div class="auth-footer"><a href="signup.php">Create a free account →</a></div>
